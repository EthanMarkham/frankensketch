    ...
    return (
        <NavDiv width="100%" margin="0 0 .5rem 0" backgroundColor={COLORS.bgPrimary} >
            ...
            <FlexBox justifyContent="space-between" margin="0 1.5rem">
                <Button background="none" borderRadius="0" onClick={() => OnClickNavButton(3)}>
                ...
                <Button background="none" borderRadius="0" onClick={() => OnClickNavButton(6)}>
                    <img src={Icons.Flipboard} alt="Community icon" />
                    <Text color={COLORS.white}>Community</Text>
                </Button>

                <Button background="none" borderRadius="0" onClick={() => OnClickNavButton(4)}>
